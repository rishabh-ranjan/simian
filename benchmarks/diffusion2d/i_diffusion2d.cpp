...
#endif
#define nxl     3   /* extent of x coordinates for local piece    */
#define nyl     3    /* extent of y coordinates for local piece    */
#define nxlg    5   /* nxl + 2 (ghost cells)                      */
#define nylg    5   /* nyl + 2 (ghost cells)                      */
...
int my_rank; MPI_Comm_rank (MPI_COMM_WORLD, &my_rank);
  ...
  MPI_Finalize();
ifs->transferInfoToScheduler(my_rank);
}
