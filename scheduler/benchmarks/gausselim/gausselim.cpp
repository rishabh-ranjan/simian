...
int CheckRow(long* row, int rownum, int size)
{
   int     i;
   int     errorcount = 0;
...
int CheckArray(long** a, int size)	/* check_array & check_row used to check res */
{
...
void TransposeAndZero(long** a, int size) 
{
...
void InitArray(long** a, int size)
{
...
void Compute(long** a, int size, int iters)
{
